...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
            <div class="main-content" id="map_canvas" style="float:left; width:100%;height:500px;"></div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="sidebar-content">
                        <pre style="display:inline">Start Date              </pre>
                        <br>
                        <br>
                        <div>
                            <button id="btn" class="btn btn-success" style="width:49%">Start Animation</button>
                            <button id="btn2" class="btn btn-danger" style="width:49%">Stop Animation</button>
                        </div>
                        <br>
                        <div class="panel">
                            <button id="btn0" class="btn btn-info" style="width:100%">Download data</button>
                        </div>
        ...
        <div class="container-fluid" style="display:inline-block" align="center">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4"><img style="display:inline-block" width="200px" height="200px"
                                                    src="http://omgsrv1.meas.ncsu.edu:8080/ocean-circulation-useast2/image/omg_logo2.png"
