		...
		<div id="box">
			...
			<div id="map">
				...
				<div id="date">
					<form>
            			<div id="buoy">
            				<span class="text">Buoy Stations</span><br/>
        ...
        <span class="text">Date:</span>
          ...
          <div id ="description">
             <h1>Instructions</h1>
                    ...
                    First, choose Sea-Level Air Pressure, Wind, or Air Temperature from the buttons above the map.<br>
                    Second, choose a date from the Date list. Dates before the present can be selected to populate the Date list.<br>
                    Third, choose a buoy station from the map or list. A plot of observational data, when avaiable, and model output will appear in a new window.</span>
