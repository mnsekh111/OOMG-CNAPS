...
<script type="text/javascript">
  ...
  function initialize() { 
	...
	//			$(this).find('ul').removeClass('noJS').stop(true,true).slideToggle('fast');
	//		});
	//	});
...
<%-- <a href="http://omgrhe.meas.ncsu.edu/Group/" title="Ocean Observing and Modeling Group"><img src="image/omg_logo2.png" width="142" height="100"></img></a><br/><br/> --%>
<%--       <a href="http://www.ncsu.edu"><img src="image/ncsu_logo.gif"/></a><br/><br/>
      <a href="http://secoora.org/"><img src="image/secoora_logo.png" width="142" height="51" /></a>
      <p></p>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.noaa.gov/"><img src="image/noaa-logo.jpg" width="110" height="110"/></a>
      &nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.renci.org//"><img src="image/renci_logo.jpg" width="110" height="80"/></a>--%>
</div>

<%-- <script>
	var depth=new Array(0,5,10,15,20,30,40,50,75,100,125,150,200,250,300,400,500,600,800,1000,1200,1500,2000);
	for(var i=0;i<23;i++)
	{
		document.write("<br/><input type='radio' id='depth[i]' name='radio' checked='checked'/><label for='depth[i]'>'depth[i]'+'m'</label>");
	}
</script>--%>
<div id="map">
		...
		<div id="depth">
		  ...
		  <form>
            <div id="variables">
				...
				<input type="radio" id="c" name="radio" checked="checked" /><label for="c"><big>Chlorophyll</big></label>
				<input type="radio" id="p" name="radio"  /><label for="p"><big>Phytoplankton</big></label>
				<input type="radio" id="z" name="radio"  /><label for="z"><big>Zooplankton</big></label>
           </div>
          </form>
