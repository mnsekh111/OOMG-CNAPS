...
<html>
    <head>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbeiqBit7rIdLkW4n1wB7ESlVHAXE0g_Q"
        ...
        <script type="text/javascript">
            ...
            function constructFullPath() {
                full_path = root + date.substring(0, 6) + "/" + date + "/" + date + "_" + time + "_" + variable;
