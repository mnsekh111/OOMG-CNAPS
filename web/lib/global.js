...
function getTwoMonthWindow(date) {
    if (date.getMonth() - 1 < 0) {
        return new Date(date.getYear() - 1, 11, 1);
    }
...
var latlng = new google.maps.LatLng(30, -80);
var myOptions = {
    zoom: 4,
    center: latlng,
...
var buoymarker = [new google.maps.Marker({
        position: buoystation[0],
        title: 'NDBC Station 41002 (LLNR 830) - South Hatteras - 225 NM South of Cape Hatteras'
    }),
    new google.maps.Marker({
        position: buoystation[1],
        title: 'NDBC Station 41008 - Grays Reef - 40 NM southeast of Savannah, GA'
    }),
    new google.maps.Marker({
        position: buoystation[2],
        title: 'NDBC Station 41012 (LLNR 845.3) - St. Augustine - 40 NM ENE of St Augustine, FL'
    }),
    new google.maps.Marker({position: buoystation[3], title: 'NDBC Station 41013 (LLNR 815) - Frying Pan Shoals, NC'}),
    new google.maps.Marker({
        position: buoystation[4],
        title: 'NDBC Station 41046 - East Bahamas - 335 NM East of San Salvador Is, Bahamas'
    }),
    new google.maps.Marker({
        position: buoystation[5],
        title: 'NDBC Station 41047 - NE Bahamas - 350 NM ENE of Nassau, Bahamas'
    }),
    new google.maps.Marker({
        position: buoystation[6],
        title: 'NDBC Station 41048 - West Bermuda -240 NM West of Bermuda'
    }),
    new google.maps.Marker({
        position: buoystation[7],
        title: 'NDBC Station 42001 (LLNR 1400) - Mid Gulf - 180 NM South of Southwest Pass, LA'
    }),
    new google.maps.Marker({
        position: buoystation[8],
        title: 'NDBC Station 42003 (LLNR 1395) - East Gulf - 208 NM West of Naples, FL'
    }),
    new google.maps.Marker({
        position: buoystation[9],
        title: 'NDBC Station 42012 - Orange Beach - 44 NM SE of Mobile, AL'
    }),
    new google.maps.Marker({
        position: buoystation[10],
        title: 'NDBC Station 42020 (LLNR 1330) - Corpus Christi - 60NM SSE of Corpus Christi, TX'
    }),
    new google.maps.Marker({
        position: buoystation[11],
        title: 'NDBC Station 42036 (LLNR 855) - West Tampa - 112 NM WNW of Tampa, FL'
    }),
    new google.maps.Marker({
        position: buoystation[12],
        title: 'NDBC Station 42056 (LLNR 110) - Yucatan Basin - 120 NM ESE of Cozumel, MX'
    }),
    new google.maps.Marker({
        position: buoystation[13],
        title: 'NDBC Station 42058 - Central Caribbean - 210 NM SSE of Kingston, Jamaica'
    }),
    new google.maps.Marker({
        position: buoystation[14],
        title: 'NDBC Station 44014 (LLNR 550) - Virginia Beach - 64 NM East of Virginia Beach, VA'
    }),
    new google.maps.Marker({
        position: buoystation[15],
        title: 'NDBC Station 42055 (LLNR 1101) - Bay of Campeche - 214 NM NE of Veracruz, MX'
    }),
    new google.maps.Marker({
        position: buoystation[16],
        title: 'NDBC Station 44037 - Buoy M01 - Jordan Basin, Gulf of Maine'
    }),
    new google.maps.Marker({position: buoystation[17], title: 'NDBC Station 44056 - Duck FRF, NC'}),
    new google.maps.Marker({
        position: buoystation[18],
        title: 'NDBC Station 44065 (LLNR 725) - New York Harbor Entrance - 15 NM SE of Breezy Point , NY'
    }),
...
function Init_hfradar_map() {
    ...
    overlayvalidation1 = new google.maps.GroundOverlay("servlet/ValServlet3?" + "day=" + hfdate.substring(0, 8) + "&" + "date=" + hfdate, imageBounds);
